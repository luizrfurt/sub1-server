...
export class AddedMigration1718039598585 implements MigrationInterface {
    name = 'AddedMigration1718039598585'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "sub1"."coasts_centers" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL, "active" boolean NOT NULL DEFAULT true, "code" character varying NOT NULL, "name" character varying NOT NULL, "context" integer NOT NULL, "user" integer NOT NULL, CONSTRAINT "PK_c3e1959a922d3d4120e394ee691" PRIMARY KEY ("id"))`);
